...
Phase 1 未宣称实现：便利贴增删/复制/合并/拆分、浏览器内逐页视觉预览、完整信息密度规则、企业母版自动分析、交付后的单页修订、10 页以上演示，以及“仅本地/仅公开”资料分支。这些能力继续按下文 Phase 2 或后续迭代验收；当前工作台的大纲修订只支持标题和顺序，并强制重新建立任务与审批上下文。资料范围固定为“公开网页 + 当前销售资料库”，本地 PDF 需先入库。
...
- 框架已有可复用 Profile 能力；当前桌面发行版只启用销售总监，可调用资料库、公开网页、PDF、销售台账和任务审计。
...
- 多人在线协作、评论和云同步。
- 动画、转场、视频和复杂媒体编排。
- Word、Excel 任意格式直接导入；MVP 仍以资料库、网页、PDF、销售 CSV 和任务快照为主。
- 自动生成演讲视频或旁白。
...
1. **左侧导航**：工作台首页、PPT 工作室、研究、销售、资料库、产物和设置。
