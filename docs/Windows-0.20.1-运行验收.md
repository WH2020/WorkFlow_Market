...
- 运行目录：`<USERPROFILE>\Agent4Market-0.20.1`
- 程序：`<USERPROFILE>\Agent4Market-0.20.1\Agent4Market.exe`
- 版本：`0.20.1`
...
```powershell
$env:WXDECIPHER_SQLCIPHER4_FIXTURE = '<PROJECT_ROOT>/outputs/verification/wxdecipher-5b29d55d24684a2abab60414ab0a3a13/sqlcipher-4.0-testkey.db'
