...
- 目录：`C:\Users\<Windows用户名>\Agent4Market-0.20.2-portable`。
...
```text
scripts/build-windows-portable.py --payload C:/Users/<Windows用户名>/Agent4Market-0.20.2-payload-20260910 --manifest <仓库根目录>/outputs/releases/0.20.2/install-manifest.json
tests/windows-portable-acceptance.py --output <仓库根目录>/outputs/verification/windows-portable-20260910
```
