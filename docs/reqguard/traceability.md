...
| REQ-001 | software-app | MOD-001 | `package.json`, `desktop/src-tauri/`, setup/build scripts and CI | TEST-BID-010 | Python 108/108、UI 50/50、Runtime 90/90、SQLite 门禁、Windows 0.15.0 构建/安装/自检/真实启动；Actions `32476316749` 全部成功并上传 macOS 通用产物 | verified | Windows 本机与远端验证通过；macOS Intel/Apple Silicon 门禁、安装器、测试和通用产物由远端 macOS 构建机验证 |
