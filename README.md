...
左侧“检查更新”和“设置 → 应用更新”可检查 GitHub Releases 正式版本。默认启动时及应用打开期间约每 5 分钟检查，可关闭自动检查；发现新版后显示版本、发布时间与更新说明。用户确认后可打开发布页，但不会自动下载、安装、覆盖或重启。发布源必须有公开正式 Release，访问失败不会显示“已是最新”。本功能不读取或上传账号配置、模型密钥或业务数据。详见 [应用更新](docs/应用更新.md)。
